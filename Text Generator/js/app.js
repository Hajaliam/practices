...
const pNum = document.querySelector("input")
const genarateBtn =document.querySelector("button")
const mainArticle =document.querySelector("article")
genarateBtn.addEventListener('click',function(event){
  event.preventDefault()
  mainArticle.innerHTML = ''
  let amount = pNum.value
  let j = 0
  ...
  for(let i = 0 ; i<amount ; ++i){
      ...
      newP.innerHTML = dummyText[j]
      mainArticle.appendChild(newP)
      ++j
  }
})